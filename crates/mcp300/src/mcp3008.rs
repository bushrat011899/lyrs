...
mod tests {
    ...
    fn mock_spi() {
        ...
        let mut mcp = Mcp3008::new(MockSpi);
        ...
        assert_eq!(mcp.read(Channel::CH4), Ok(104));
        assert_eq!(mcp.read(Channel::CH5), Ok(105));
        assert_eq!(mcp.read(Channel::CH6), Ok(106));
        assert_eq!(mcp.read(Channel::CH7), Ok(107));
    }
}
